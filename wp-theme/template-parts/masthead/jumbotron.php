...
<div class="jumbotron-wrapper" <?= $jumbotron_wrapper_style ?>>
    ...
    <div class="jumbotron jumbotron-fluid" style="background:transparent;margin-bottom:0;padding:2rem 1rem;">
    ...
    <?php if (!empty($caption)) { ?>
        <div class="pb-1 text-right" style="margin-top:-2rem;opacity:0.75;">
